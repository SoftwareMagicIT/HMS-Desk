...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: Arc<RwLock<String>> = Arc::new(RwLock::new("Helpdesk".to_owned()));
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["helpdesk.softwaremagic.net"];
pub const PUBLIC_RS_PUB_KEY: &str = "6w7Vyzm5vwKqWoEAW99Gc54Qkg3+Fzf0wuGsO18SAEU=";
