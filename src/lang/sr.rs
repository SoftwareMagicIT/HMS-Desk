...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na Helpdesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC Helpdesk ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate Helpdesk na sistem."),
        ...
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, Helpdesk-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, Helpdesk-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite Helpdesk-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [Helpdesk Input] servis."),
        ...
        ("Language", "Jezik"),
        ("Keep Helpdesk background service", "Zadrži Helpdesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje Helpdesk aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ("Start on boot", ""),
        ...
        ("Show Helpdesk", "Prikazi Helpdesk"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
