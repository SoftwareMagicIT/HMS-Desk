...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete HMS-Desk..."),
        ...
        ("install_tip", "A causa del controllo account uUtente (UAC), HMS-Desk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare HMS-Desk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a HMS-Desk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a HMS-Desk il permesso 'Registrazione schermo'."),
        ...
        ("Show RustDesk", "Visualizza HMS-Desk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a HMS-Desk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a HMS-Desk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di HMS-Desk."),
        ...
        ("install_cert_tip", "Installa certificato HMS-Desk"),
        ("confirm_install_cert_tip", "Questo è un certificato di test HMS-Desk, che può essere considerato attendibile.\nIl certificato verrà usato per certificarsi ed installare i driver HMS-Desk quando richiesto."),
