...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connexió a la xarxa Helpdesk en progrés..."),
        ...
        ("android_input_permission_tip1", "Per a que un dispositiu remot controli el seu dispositiu Android amb el ratolí o tocs, cal permetre que Helpdesk utilitzi el servei d' \"Accesibilitat\"."),
        ("android_input_permission_tip2", "Vagi a la pàgina de [Serveis instal·lats], activi el servici [Helpdesk Input]."),
        ...
        ("Turned off", "Apagat"),
        ("Language", "Idioma"),
        ("Keep Helpdesk background service", "Mantenir Helpdesk com a servei en segon pla"),
